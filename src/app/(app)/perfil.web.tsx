...
export default function ProfileScreen() {
    ...
    const pickImage = async () => {
        try {
            // Tratamento de Permissões (O Web ignora isso, mas evita travamentos no Mobile)
            if (Platform.OS !== 'web') {
            ...
            // Abre a janela para escolher a foto
            ...
            // Se o usuário escolheu uma foto, salva a URI no estado
            if (!result.canceled) {
